/**
 * Mirrors the C# Book model returned by the API.
 *
 ...
 * Includes both the page of books AND the pagination metadata
 * needed to render the Previous / Next / page-number controls.
 */
export interface BooksResponse {
  books: Book[];      // The books on the current page
  totalBooks: number; // Total books in the database (across all pages)
